...
A clean, compact UDP tunnel + TeamTest launcher for Roblox Studio.
...
- Allow through Windows Defender on first run if prompted.

---

<sub>Author: **@s0m3thing_matters** · Discord: `discord.gg/H3K2xeU96A`</sub>
